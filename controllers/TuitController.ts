 ...
 export default class TuitController implements TuitControllerI {
     ...
     public static getInstance = (app: Express): TuitController => {
         if(TuitController.tuitController === null) {
             ...
             app.get("/api/tuits", TuitController.tuitController.findTuits);
      ...
      */
     findTuits = (req: Request, res: Response) =>
         TuitController.tuitDao.findTuits().then((tuits: Tuit[]) => res.json(tuits));
