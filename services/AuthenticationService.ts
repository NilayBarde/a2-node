...
const DB_USERNAME = "nilaybarde"; //process.env.DB_USERNAME;
const DB_PASSWORD = "oPpleA9vA3IPwAlE"; //process.env.DB_PASSWORD;
...
export const initializeSalaries = (salary: number) => {
    return userDao.findAllUsers().then((users) => {
...
//
login("alice008", "alice234").then((user) => console.log(user));
